...
geo = pd.read_csv(con.REF_GEOGRAPHY)
...
# document output 
obs_per_ent.to_parquet(results_path / "obs_per_ent.parquet", index=True)
obs_per_cntry.to_parquet(results_path / "obs_per_cntry.parquet", index=True)
